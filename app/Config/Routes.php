...
$routes->group('produk', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('tambah', 'Produk::create');
...
$routes->group('supplierproduk', ['filter' => 'auth'], function ($routes) {
    $routes->get('/', 'SupplierProduk::index');
    $routes->get('tambah', 'SupplierProduk::create');
    $routes->post('store', 'SupplierProduk::store');
});
